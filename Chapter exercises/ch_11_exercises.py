...
def main():
    my_house = SingleFamilyHome(6, 1200, 1, "single car garage", "0.25 acres")
    print(my_house.get_number_of_rooms())
    print(my_house.get_square_feet())
    print(my_house.get_floors())
    print(my_house.get_garage_type())
    print(my_house.get_yard_size())
...
def main2():
    mammal_object = Mammal('Regular mammal')
    mouse_object = Mouse()
    sheep_object = Sheep()

    show_mammal_info(mammal_object)
    show_mammal_info(mouse_object)
    show_mammal_info(sheep_object)
