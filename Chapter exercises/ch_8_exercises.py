...
if name.isdigit():
    print("Theres a number in the string")
else:
    print("Theres no number")
# 4) Test to see if number contains a number, print the result
number = "42"
if number.isdigit():
    print("The variable number contains a number")
...
the_replaced_letter_index = name.find("J")
print(name[the_replaced_letter_index].lower())
