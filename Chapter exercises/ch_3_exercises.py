...
if tired is False and hungry is False:
    print("Eyes open and quiet")
elif tired is True and hungry is True:
    print("Eyes closed and crying")
elif tired is True and hungry is False:
    print("Eyes closed and quiet")
else:
    print("Eyes open and quiet")
